// The SWATResponder is a child of the Responder class and is the only unit able to solve SWAT Emergencies
public class SWATResponder extends Responder{
	
	// Standard Constructor the will create a random name for the unit
	public SWATResponder(){
	...
	public boolean respond(Emergency emergency){
		...
		// If the SWAT attempts to solve an emergency that is not of it's type then it will print an error
